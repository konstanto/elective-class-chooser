    ...
    public render() {
        return (
            <div className="rules">
                ...
                <p>Din uddannelse følger den pågældende studieordning, der var tilknyttet da du startede til studie. I Dine Valgfag finder vi nemt og hurtigt den studieordning, som passer til dit valgfag.</p>
                ...
                <p>Når du finder valgfag via vores hjemmeside, skal du være opmærksom på, at Dine Valgfag ikke tager højde for en studieplan, hvor der tages 45 ECTS-point på et år.</p>
...
det betyder altså at 2/3 af dine eksamener skal bedømmes af en intern censor.</p>
                ...
                <p><b>BEMÆRK</b><br />
                    Dine Valgfag tager ikke højde for studerende, som har fået dispensation fra studiet. Du kan dog stadig søge efter valgfag, men bemærk at Dine Valgfags vejledende studieplan kan være misvisende.</p>
